...
I am currently a fourth-year undergraduate at the [SUSTech](https://www.sustech.edu.cn/en/) <img src="images/logos/sustech.png" alt="SUSTech logo" width="40" style="vertical-align: text-bottom;">, majoring in Computer Science and Technology.
...
platform that supports three commonly used visuo-tactile sensors
...
<div style="background: #e8e8e8; padding: 10px; border-radius: 8px; display: inline-block;">
  <script type="text/javascript" id="mapmyvisitors" src="//mapmyvisitors.com/map.js?d=UPC5SkZbTESCudpR0wHMP0aSDeIuolS1uhp2TCTtDSw&cl=1a2f2d&co=ffffff&w=a"></script>
</div>
